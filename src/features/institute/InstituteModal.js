...
const InstituteModal = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        axios.post('http://localhost:8000/api/v1/institute', inputData)
            .then(res => {
                setInputData(data);
                closeModal(true)
            })
                                            ...
                                            <div className=''>
                                                <div className='mx-1'>
                                                    <label className="label">
                                                        <span className="label-text text-black font-semibold">Institute Name:</span>
                                                    </label>
                                                    <input type="text"
                                                        value={inputData.name}
                                                        name='name'
                                                        onChange={handleData}
                                                        placeholder="Institute Name" className="input input-bordered w-full " required />
                                                </div>
